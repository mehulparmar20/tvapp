...
import com.yahumott.tvapp.ui.IconHeaderItem;
import com.yahumott.tvapp.ui.activity.LeanbackActivity;
import com.yahumott.tvapp.ui.Utils;
import com.yahumott.tvapp.ui.presenter.IconHeaderItemPresenter;
...
public class CustomHeadersFragment extends HeadersSupportFragment {
    ...
    private void setHeaderAdapter() {
        ...
        String[] headerItem = new String[]{"Home", "Movies", "TV Series", "Genre","Favorite", "My Account"};

        int[] headerIcon = new int[]{R.drawable.outline_home_24, R.drawable.outline_movie_24,
                R.drawable.outline_local_movies_24,  R.drawable.outline_folder_24,
